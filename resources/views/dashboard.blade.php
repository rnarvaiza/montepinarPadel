            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-5">
                ...
                <table class="w-full text-md rounded mb-4">
                    ...
                    <tr class="border-b">
                        ...
                        <th class="text-left p-3 px-5">Opciones</th>
                    </tr>
                    </thead>
                    <tbody>
                    ...
                    <tr class="border-b hover:bg-orange-100">
                        ...
                        <td class="p-3 px-5">
                            ...
                            <a href="/booking/{{$booking->id}}" name="edit" class="mr-3 text-sm bg-blue-500 hover:bg-blue-700 text-white py-1 px-2 rounded focus:outline-none focus:shadow-outline">Editar</a>
